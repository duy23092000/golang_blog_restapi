...
func (a *App) Initialize(config *config.Config) {
	...
	a.setRouters()
	fmt.Println("Application is started at port", config.Port)
}
...
func (a *App) setRouters() {
	...
	// Routing for handing the blogs
	a.Get("/blogs", a.handleRequest(handler.GetAllBlogs))
	a.Post("/blogs", a.handleRequest(handler.CreateBlogs))
}
